...
public class MessageType {
	...
	// 服务端消息类型
	public static final byte NO_CHANGE = 0x10;
	public static final byte SUCCESS = 0x11;
	public static final byte ERROR = 0x12;

	public static final byte NO_MIGRATE = 0x13;

	/**
	 * 秘钥限速
	 */
	public static final byte PUSH_WLOCK_KEY_OVERSPEED = (byte)0x01;
