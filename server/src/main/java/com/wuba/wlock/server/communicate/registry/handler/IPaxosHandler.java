...
public interface IPaxosHandler {

	RegistryProtocol buildMessage() throws ConfigException;

	boolean handleResponse(RegistryProtocol registryProtocol) throws Exception;
}
