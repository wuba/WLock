...
public abstract class AbstractMetaStateMachine implements StateMachine {
	private static MetaCheckpointManager checkpointManager = MetaCheckpointManager.getInstance();

	protected int groupIdx;
	private int smID;

	public AbstractMetaStateMachine(int groupIdx, int smID, boolean needCheckpoint) {
